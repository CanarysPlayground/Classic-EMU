...
if __name__ == "__main__":
    ...
    if not GITHUB_ORG or not GITHUB_PAT:
        print("Error: Please set GITHUB_ORG and GITHUB_PAT in your .env file")
        logging.error("Missing GITHUB_ORG or GITHUB_PAT environment variables.")
        exit(1)

    try:
        repositories = get_github_repos(GITHUB_ORG, GITHUB_PAT)
